    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('k_value', models.DecimalField(decimal_places=2, max_digits=6)),
                ('k_pdv', models.PositiveSmallIntegerField()),
                ('na_value', models.DecimalField(decimal_places=2, max_digits=6)),
                ('na_pdv', models.PositiveSmallIntegerField()),
                ('phos_value', models.DecimalField(decimal_places=2, max_digits=6)),
                ('phos_pdv', models.PositiveSmallIntegerField()),
                ('protien_value', models.DecimalField(decimal_places=2, max_digits=6)),
                ('fat_value', models.DecimalField(decimal_places=2, max_digits=6)),
                ('carbs_value', models.DecimalField(decimal_places=2, max_digits=6)),
